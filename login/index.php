<?php
    ...
    if($requiereAutenticacion && !$autenticacion->esAdmin()) {
...
<head>
    ...
    <meta name="description" content="En Arance libros podrás encontrar el libro que buscas en el mejor formato para vos">
    ...
    <title>Panel de Administración :: <?= $rutas[$vista]['title'] ?? 'RockOnPasta';?></title>
</head>
                ...
                <div class="collapse navbar-collapse" id="navegacion">
                    ...
                    ?>
                        <ul class="navbar-nav text-center">
                            <li class="nav-item">
                                <a class="nav-link" href="index.php?s=homeAdmin">Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="index.php?s=catalogo">Catálogo</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="index.php?s=carrito">Adm Carrito</a>
                            </li>
                            <li class="nav-item">
